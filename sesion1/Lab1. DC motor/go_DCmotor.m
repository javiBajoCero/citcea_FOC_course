...
Environment.Tamb = 25;          % Ambient temperature [oC]
...
Motor.Thermal.C_thcase = Motor.Thermal.tau_thcase/Motor.Thermal.R_thcase_amb;
...
Motor.Thermal.C_thwind = Motor.Thermal.tau_thwind/Motor.Thermal.R_thwind_case;
...
% Pole imposition
Control.Speed.tau_v = 0.15;
Control.Speed.Kp_v = Vehicle.mv/Control.Speed.tau_v;
...
Control.Current.Kaw_i = Control.Current.Kp_i;
